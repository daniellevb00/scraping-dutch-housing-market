---
title: "Scraper Huizenzoeker.nl to Analyse the Dutch Housing Market"
output:
        html_document:
                theme: united
                toc: true
...
### Motivation to scrape Huizenzoeker.nl
...
This dataset is created for the course [Online Data Collection and Management](https://odcm.hannesdatta.com) at Tilburg University, as part of the Master's program 'Marketing Analytics'. The contributors of the project are:
...
There was no funding granted for creating the dataset.
...
##### In which provice of the Netherlands are houses currenlty most outbid?

```{r, setup, include=FALSE}
knitr::opts_knit$set(root.dir = '/Final source code')
```
